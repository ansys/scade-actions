...
call ..\..\suite-coverage\AcquireCoverage.bat "c:\Program Files\ANSYS Inc\v242\SCADE" "Test/xTest.etp" "Test" tmp\TestResults.etp
if errorlevel 1 (
...
call ..\..\suite-coverage\AcquireCoverage.bat "c:\Program Files\ANSYS Inc\v242\SCADE" "Test/Test.etp" "Unknown" tmp\TestResults.etp
if errorlevel 1 (
