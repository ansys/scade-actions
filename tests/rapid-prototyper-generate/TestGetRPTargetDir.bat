@echo off
"c:\Program Files\ANSYS Inc\v242\SCADE\SCADE\bin\SCADE.exe" -script Model/Model.etp ..\..\rapid-prototyper-generate\get_sdy_target_dir.py "main('Code')" > log.txt 2> err.txt
